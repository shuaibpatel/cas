...
class DependenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependency" do
    assert_difference('Dependency.count') do
      post dependencies_url, params: { dependency: { authors: @dependency.authors, name: @dependency.name, version: @dependency.version } }
    end
  ...
  test "should update dependency" do
    patch dependency_url(@dependency), params: { dependency: { authors: @dependency.authors, name: @dependency.name, version: @dependency.version } }
